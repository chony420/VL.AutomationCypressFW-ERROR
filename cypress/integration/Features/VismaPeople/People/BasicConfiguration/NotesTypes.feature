@vlpeople-nightly
Feature: People -> Configuracion Basica -> Types of notes

As a user I want to:
        - Navigate for the differents menues option and links
        - Check the different field Validations
        - Create, modify and delete types of notes
...
Background: (Repeats on all scenarios)
        ...
        Then I wait until DOM is loaded
        And I go to card 'Note Type'
        And I load file 'NoteType' from 'VismaLatam/People'
@Smoke
Scenario: Navigation
        ...
        And I go to card 'Note Type'
        Then I wait until DOM is loaded
        And I validate user to be on the 'Note Type' page  
        ...
        Then I wait until DOM is loaded
        And I validate user to be on the 'Create Note Type' page
...
Scenario: Validations
        Then I click button 'Create'
        Then I wait until DOM is loaded
        And I set field 'Description' with 'Generales'
        ...
        And I set field 'Description' with 'Generales'
        Then I 'mark' checkbox in 'Confidential'
        Then I 'unmark' checkbox in 'Confidential'
...
@Smoke
Scenario: Create a type of note
        Then I click button 'Create'
        Then I wait until DOM is loaded
...
@Smoke
 Scenario: Modify a type of note 
        Then I set filter field 'Filter Note Type' with 'Cypress Automation Test'
...
Scenario: Delete a type of note     
        Then I set filter field 'Filter Note Type' with 'Cypress Automation Test 2'
